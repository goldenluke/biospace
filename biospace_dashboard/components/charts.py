...
Helpers de gráficos reutilizáveis entre páginas, migrados no espírito de
components/charts.py da pipeline legada (histograma_faixas), agora sobre
plotly puro.
"""
...
ORDEM_CLASSE_APNEIA = ["Normal", "Leve", "Moderada", "Grave"]
...
def histograma_faixas(
    ...
    """
    Histograma colorido por faixas clínicas, ex.:
        faixas=[(None, 5, "#00C853", "Normal"), (5, 15, "#FFD600", "Leve"), ...]
    """
