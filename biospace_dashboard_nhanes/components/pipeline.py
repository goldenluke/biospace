...
from biospace.plugins.metabolic import MetabolicRepresentation, classify_diabetes_status, classify_metabolic_syndrome_risk, load_from_dataframe
...
def run_pipeline(data_dir: str, idade_minima: int = 20, max_pacientes: int | None = None) -> Pipeline:
    """Carrega os 6 arquivos NHANES reais, filtra por idade mínima, roda a representação e as duas interpretações clínicas."""
